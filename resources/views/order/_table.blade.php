<div class="w-full overflow-x-auto">
    <table class="w-full table-auto border border-gray-300 dark:border-gray-700 divide-y divide-gray-300 dark:divide-gray-700 text-gray-800 dark:text-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-300 dark:divide-gray-700">
            @forelse ($orders as $key => $order)
                <tr class="flex flex-col md:table-row hover:bg-gray-50 dark:hover:bg-gray-800">
                    <td class="px-4 py-2 md:whitespace-nowrap md:table-cell"><span class="md:hidden font-semibold">No:</span>
                    ...
                    <td class="px-4 py-2 md:whitespace-nowrap md:table-cell"><span class="md:hidden font-semibold">Kategori:</span> {{ $order->category->name ?? '-' }}</td>
